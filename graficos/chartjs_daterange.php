...
if( !isset( $_REQUEST )){
    $_REQUEST['data_inicio'] = '2022-01-01';
    $_REQUEST['data_fim'] = '2022-01-05';
...
function verifica_motivo(){
    ...
    $sql_todos  = "SELECT  Codigo_Motivo, COUNT(*) as Total_Por_Motivo FROM chamado
                    WHERE DH_Chamado >= '".$_REQUEST['data_inicio']." 00:00:01' 
                    AND DH_Chamado <= '".$_REQUEST['data_fim']." 23:59:59' ";
...
<!--  -->
    ...
    <!-- Segundo teste de date range picker -->
...
<!-- 
       ...
       <div class="row">
        <div class="col-md-6">
            <div class="border border-primary">
                ...
                <button type="button" class="btn btn-info" onclick="encaminha_dados();">Info</button>
                </div>
    ...
    <!-- ate aqui - é o seguindo  -->


        <!-- date range com classificação  -->
        <!-- <div class="row">
            <div class="box-body">
    ...
    <!-- ate aqui data range com classificacao  -->

        <h2> Formulário para os graficos </h2>
        <form action="chartjs_daterange.php" method="POST">
            <div class="form-group">
                <label for="exampleInputEmail1">Escolha o tempo </label>
                <div id="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
                    <i class="fa fa-calendar"></i>&nbsp;
                    <span></span> <i class="fa fa-caret-down"></i>
                </div>
              
                <small id="emailHelp" class="form-text text-muted"> Sem escolha .</small>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Segunda escolha o tempo </label>
                <input type="text" name="daterange" value="01/01/2022 - 01/15/2022" />
                <small id="emailHelp" class="form-text text-muted"> Funciona a escolha .</small>
            <div class="form-group">   
            <label for="exampleInputEmail1">Resposta da escolha do tempo  </label> 
                <input type="text" name="resposta_date" id="resposta_date" value="" >           
            </div>
            <div class="form-group">
            <label for="exampleInputEmail1">Resposta do tempo inicial  </label>
                <input type="text" id="data_inicio" name = "data_inicio" >
            </div>
            <div class="form-group">
            <label for="exampleInputEmail1">Resposta do tempo final </label>
                <input type="text" name="data_fim" id="data_fim">
            </div>
...
$(function() {
  $('input[name="daterange"]').daterangepicker({
    ...
    //donsole.log("Uma nova data selecionada começando em  : " + start.format('DD/MM/YYYY') + '  e indo até  ' + end.format('DD/MM/YYYY'));
    document.getElementById('resposta_date').value = data_inicio + ' ' + data_fim ;
